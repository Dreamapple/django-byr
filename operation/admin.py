...
class TopicVoteAdmin(admin.ModelAdmin):
    # 要列出的字段
    list_display = ('id', 'user', 'topic_s', 'vote', 'thanks', 'favorite', 'add_time',)
    # 可以搜索的字段
    search_fields = ('user', 'topic_s')
    # 列出可以编辑的字段
...
class FavoriteNodeAdmin(admin.ModelAdmin):
    # 要列出的字段
    list_display = ('id', 'user', 'node_s', 'favorite', 'add_time',)
    # 可以搜索的字段
    search_fields = ('user', 'node_s')
    # 列出可以编辑的字段
